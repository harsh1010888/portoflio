...
const ExperienceCard = ({ experience }) => (
  ...
  >
    <div>
      ...
      <p className='text-secondary text-[16px] font-semibold m-0'>{experience.company}</p>
    </div>
...
const Experience = () => (
  <>
    <motion.div variants={textVariant()}>
      <p className={`${styles.sectionSubText} text-center`}>What I've Done</p>
    ...
    >
      A snapshot of roles and contributions where I applied my skills to build impactful solutions and collaborate effectively.
    </motion.p>
